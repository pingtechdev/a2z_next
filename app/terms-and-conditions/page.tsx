                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl w-full overflow-hidden">
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-6 sm:p-8 md:p-10">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">1. Acceptance</h2>
                            <p>
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">2. Services</h2>
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">3. User Responsibilities</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">4. Payments</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">5. Limitation of Liability</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">6. Intellectual Property</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">7. Privacy</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">8. Governing Law</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
                        ...
                        <section className="mb-6 sm:mb-8">
                            <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-900 mb-3 sm:mb-4">9. Change to Terms</h2>
                            <ul className="list-disc pl-6 mt-4 space-y-2">
